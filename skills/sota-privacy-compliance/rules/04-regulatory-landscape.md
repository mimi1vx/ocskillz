...
Imported upstream statuses include claims through **early July 2026**. Treat
them as unverified locally: re-verify every applicable date against current
primary sources and route interpretation to counsel (this is engineering
...
the data map and LINDDUN threat model — don't write it
from scratch.
...
**Timeline (imported snapshot — moving target, re-verify):**
