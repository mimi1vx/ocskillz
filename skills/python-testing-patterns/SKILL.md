...
# Run with:
# python3 -m pytest -m slow          # Run only slow tests
# python3 -m pytest -m "not slow"    # Skip slow tests
# python3 -m pytest -m integration   # Run integration tests
```
...
python3 -m pytest --cov=myapp --cov-report=html tests/

# Fail if coverage below threshold
python3 -m pytest --cov=myapp --cov-fail-under=80 tests/

# Show missing lines
python3 -m pytest --cov=myapp --cov-report=term-missing tests/
```
...
- **responses**: mock for request library    
